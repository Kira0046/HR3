...
public class LeftCollisionNote : MonoBehaviour
{

    const string BASE_TEXTURE = "NoteTexture/leftCollision";
    ...
    private void Awake()
    {
        ...
        GameObject spriteObject = GameObject.Find("LeftNoteCollision");
